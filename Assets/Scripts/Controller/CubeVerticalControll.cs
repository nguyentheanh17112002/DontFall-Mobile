...
public class CubeVerticalControll : MonoBehaviour {
	...
	void Update () {
        ...
        if (GameController.Instance._isGameAlive)
        {
            ...
            if (GameController.Instance._control_Horizontal && GameController.Instance.Cube_Horizontal.childCount == numberChild)
            {
            ...
            if (GameController.Instance.Cube_Horizontal1.childCount == numberChild && GameController.Instance._control_Horizontal)
            {
                DestroyAllChild();
            }
